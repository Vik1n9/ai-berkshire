...
**チームリード（あなた）**：調整・統合・意思決定を担い、以下の4エージェントを並列実行——

| エージェント1 · 段永平 | エージェント2 · バフェット | エージェント3 · マンガー | エージェント4 · 李録 |
|:---:|:---:|:---:|:---:|
| ビジネスモデル | 財務分析 | 業界・競合 | リスク・マネジメント |

↓ 並列リサーチ、リアルタイム進捗。最後にチームリードが**最終統合レポート**を出力

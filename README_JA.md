...
/thesis-tracker 拼多多
/thesis-drift 拼多多 reports/<企業>/<旧期間>.md reports/<企業>/<新期間>.md
/news-pulse テンセント
...
完全レポート：AI算力 · AIモデル · AIアプリケーション · AIインフラ＆電力
...
> 以下はこのフレームワークで生成されたリサーチ事例の要約です。AI駆動リサーチの実際のアウトプット品質を示しています。レポート全文は `reports/` に格納されます。

| 企業 | 使用Skill | コア結論 |
|-----|---------|---------|
| 拼多多（PDD） | `/investment-team` | 総合3.4/5——極めて安いが10年の確実性は不十分；モデレートなポジションに適切 |
| テンセント（0700.HK） | `/investment-research` | ソーシャル独占＋優れた資本配分；先行PER14倍は妥当〜低い |
| 7社比較 | `/investment-checklist` | 茅台＆テンセントは合格；NVIDIA、美団＆快手は条件付き；拼多多＆泡泡玛特はグレーゾーン |
| 巨人保有銘柄トラッカー | カスタムリサーチ | バフェット / 李録 / 段永平の最新13F保有銘柄＋PDDコスト基準分析 |

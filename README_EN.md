...
Full reports: [AI Compute](reports/AI算力-funnel-20260509.md) · [AI Models](reports/AI模型-funnel-20260509.md) · [AI Applications](reports/AI應用-funnel-20260509.md) · [AI Infrastructure & Power](reports/AI基建電力-funnel-20260509.md)
...
| Tencent (0700.HK) | `/investment-research` | Social monopoly + superior capital allocation; 14x forward P/E is reasonable-to-low | [View Report](reports/騰訊/) |
| 7-Company Comparison | `/investment-checklist` | Moutai & Tencent pass; NVIDIA, Meituan & Kuaishou conditional; Pinduoduo & Pop Mart gray zone | [View Report](reports/多公司對比-checklist-20260408.md) |
| Master Holdings Tracker | Custom Research | Buffett / Li Lu / Duan Yongping latest 13F holdings + PDD cost-basis analysis | [View Report](reports/大師持倉追蹤-research-20260408.md) |

...
/thesis-drift Pinduoduo reports/<company>/<old-period>.md reports/<company>/<new-period>.md
/news-pulse Tencent
...
> Below are case summaries of real research produced with this framework, showcasing actual AI-powered research output quality. Full reports live under `reports/`.

| Company | Skill Used | Core Conclusion |
|---------|-----------|----------------|
| Pinduoduo (PDD) | `/investment-team` | Composite 3.4/5 — extremely cheap but 10-year certainty insufficient; suitable for moderate position |
| Tencent (0700.HK) | `/investment-research` | Social monopoly + superior capital allocation; 14x forward P/E is reasonable-to-low |
| 7-Company Comparison | `/investment-checklist` | Moutai & Tencent pass; NVIDIA, Meituan & Kuaishou conditional; Pinduoduo & Pop Mart gray zone |
| Master Holdings Tracker | Custom Research | Buffett / Li Lu / Duan Yongping latest 13F holdings + PDD cost-basis analysis |
